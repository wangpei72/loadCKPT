...
def S_P_D_adult_age(X, y):
    unprivileged_boolean_condition_vector = compute_boolean_conditioning_vector(X, condition=[{'age': 1}, {'age': 2}, {'age': 3}])
    privileged_boolean_condition_vector = compute_boolean_conditioning_vector(X, condition=[{'age': 4},
                                                                                            {'age': 5},
                                                                                            {'age': 6}, {'age': 7},
                                                                                            {'age': 8},
                                                                                            {'age': 9}])
...
def S_P_D_bank(X, y):
    ...
    privileged_boolean_condition_vector = compute_boolean_conditioning_vector(X, feature_names=bank_map, condition=[{'age': 4},
                                                                                            {'age': 5},
                                                                                            {'age': 6}, {'age': 7},
                                                                                            {'age': 8},
                                                                                            {'age': 9}])
